...
<head>
    ...
    <style>
        ...
        .tab-active { background-color: #dcfce7; color: #166534; font-weight: 600; }
        .logout-btn { 
            position: fixed; 
            bottom: 20px; 
            left: 20px; 
...
<body class="bg-green-50">
    <div class="flex min-h-screen">
        ...
        <div class="w-64 bg-white shadow p-4 relative h-screen sticky top-0">
            <h1 class="text-xl font-bold text-green-600 mb-8"><?php echo htmlspecialchars($restaurant_name); ?></h1>
            <nav class="space-y-2">
                <a href="?tab=orders" class="block py-2 px-4 rounded hover:bg-green-50 <?php echo $current_tab=='orders'?'tab-active':'text-gray-700'; ?>">
                    <i class="fas fa-list-alt mr-2"></i> Đơn hàng
                </a>
                <a href="?tab=menu" class="block py-2 px-4 rounded hover:bg-green-50 <?php echo $current_tab=='menu'?'tab-active':'text-gray-700'; ?>">
                    <i class="fas fa-utensils mr-2"></i> Quản lý menu
                </a>
                <a href="?tab=revenue" class="block py-2 px-4 rounded hover:bg-green-50 <?php echo $current_tab=='revenue'?'tab-active':'text-gray-700'; ?>">
                    <i class="fas fa-chart-line mr-2"></i> Doanh thu
                </a>
            </nav>

            <a href="?logout=1" class="logout-btn py-2 px-4 rounded text-white bg-green-600 hover:bg-green-700">
            ...
            <?php if ($current_tab == 'orders'): ?>
                <?php if (isset($_GET['order_id']) && isset($order_detail) && $order_detail): ?>
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        <a href="?tab=orders" class="inline-flex items-center text-green-500 mb-4">
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div class="text-right">
                                            <p class="<?php 
                                                ...
                                                ($order['status']=='delivering'?'text-teal-600':
                        ...
                        <form method="POST" enctype="multipart/form-data" class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="3"
                                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500"><?php echo htmlspecialchars($edit_item['description']); ?></textarea>
                            </div>
                            ...
                            <div class="flex justify-end space-x-3 pt-4">
                                ...
                                <button type="submit" name="save_menu_item" class="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 flex items-center">
                        ...
                        <table class="min-w-full">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="py-3 px-4">
                                        <a href="?tab=menu&edit_item=<?php echo $item['id']; ?>" class="text-green-500 hover:underline mr-2">
